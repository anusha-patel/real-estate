...
import SearchFillters from "@/components/SearchFillters";
import Property from "@/components/Property";
import NoImages from "../assets/no_images.png"
        ...
        <Box>
            ...
            {properties.length === 0 && (
                <Flex justifyContent='center' alignItems='center' flexDirection="column" marginTop="5 " marginBottom="5" > 
                   <Image alt="no result" src={NoImages}/> 
                   <Text>
                    No Result found
                   </Text>
                </Flex>
